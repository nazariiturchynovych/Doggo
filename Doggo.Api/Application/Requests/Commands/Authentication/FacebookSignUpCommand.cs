...
{
    public class Handler : IRequestHandler<FacebookSignUpCommand, CommonResult>
    {
        private readonly UserManager<User> _userManager;
        private readonly IFacebookAuthService _facebookAuthService;

        public Handler(UserManager<User> userManager, IFacebookAuthService facebookAuthService)
        {
