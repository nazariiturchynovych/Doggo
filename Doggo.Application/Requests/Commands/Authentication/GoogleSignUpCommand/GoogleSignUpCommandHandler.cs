...
public class GoogleSignUpCommandHandler : IRequestHandler<GoogleSignUpCommand, CommonResult>
{
    private readonly UserManager<User> _userManager;
    private readonly IGoogleAuthService _googleAuthService;

    public GoogleSignUpCommandHandler(UserManager<User> userManager, IGoogleAuthService googleAuthService)
    {
