...
{
    public class Handler : IRequestHandler<ApplyJobCommand, CommonResult>
    {
        ...
        public Handler(ICurrentUserService currentUserService, IJobRepository jobRepository, IDogOwnerRepository dogOwnerRepository)
        {
