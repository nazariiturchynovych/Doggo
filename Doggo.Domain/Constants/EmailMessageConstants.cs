...
public static class MyClassSome
{
    public static string FormatHtmlBody(string link)
    {
        var a = @"
<html lang=""en"">
  <head>
...
";
        ...
        var b = "<td> <a href = '{0}'> Confirm your Email </td>";
...
";
        ...
        var stringWithLink = string.Format(b, link);

        var stringTogether = a + stringWithLink + c;
                      ...
                      <tr>
                        <td align=""left"">
                          <table role=""presentation"" border=""0"" cellpadding=""0"" cellspacing=""0"">
                            <tbody>
                              <tr>
                                <td> <a href = '{0}'> link </a>Call To Action</a> </td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
